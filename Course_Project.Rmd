...
With the previous training, the model have `r sum(prediction != crossVal$classe)` misclassification from `r length(crossVal$classe)` samples. It means that the accuracy of the model is `r 1-sum(prediction != crossVal$classe) / length(crossVal$classe)`. How the accuracy of the model is excellent, it is not necessary to train another model.
